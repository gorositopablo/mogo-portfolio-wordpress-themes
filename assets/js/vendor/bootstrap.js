  ...
  Button.prototype.toggle = function () {
    ...
    if (jQueryparent.length) {
      ...
      if (jQueryinput.prop('type') == 'radio') {
        ...
        else jQueryparent.find('.active').removeClass('active')
      }
...
+function (jQuery) {
  ...
  var Collapse = function (element, options) {
    ...
    this.jQuerytrigger      = jQuery(this.options.trigger).filter('[href="#' + element.id + '"], [data-target="#' + element.id + '"]')
  ...
  Collapse.prototype.show = function () {
    ...
    var activesData
    var actives = this.jQueryparent && this.jQueryparent.find('> .panel').children('.in, .collapsing')
  ...
  jQuery(document).on('click.bs.collapse.data-api', '[data-toggle="collapse"]', function (e) {
    ...
    var option  = data ? 'toggle' : jQuery.extend({}, jQuerythis.data(), { trigger: this })
...
+function (jQuery) {
  ...
  Dropdown.prototype.keydown = function (e) {
    ...
    var jQueryitems = jQueryparent.find('[role="menu"]' + desc + ', [role="listbox"]' + desc)
...
+function (jQuery) {
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.jQuerybackdrop = jQuery('<div class="modal-backdrop ' + animate + '" />')
        .prependTo(this.jQueryelement)
        .on('click.dismiss.bs.modal', jQuery.proxy(function (e) {
  ...
  Modal.prototype.adjustBackdrop = function () {
    this.jQuerybackdrop
      .css('height', 0)
      .css('height', this.jQueryelement[0].scrollHeight)
  }
  ...
  Modal.prototype.resetScrollbar = function () {
    this.jQuerybody.css('padding-right', '')
  }
...
+function (jQuery) {
  ...
  Tooltip.prototype.init = function (type, element, options) {
    ...
    this.jQueryviewport = this.options.viewport && jQuery(this.options.viewport.selector || this.options.viewport)
  ...
  Tooltip.prototype.enter = function (obj) {
    ...
    if (self && self.jQuerytip && self.jQuerytip.is(':visible')) {
      self.hoverState = 'in'
      return
    }
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        var jQuerycontainer   = this.options.container ? jQuery(this.options.container) : this.jQueryelement.parent()
        var containerDim = this.getPosition(jQuerycontainer)
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (selector) {
        if (!data) jQuerythis.data('bs.tooltip', (data = {}))
...
+function (jQuery) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (!data && option == 'destroy') return
      if (selector) {
        if (!data) jQuerythis.data('bs.popover', (data = {}))
...
+function (jQuery) {
  ...
  function ScrollSpy(element, options) {
    ...
    this.jQueryscrollElement = jQuery(element).is('body') ? jQuery(window) : jQuery(element)
    ...
    this.jQueryscrollElement.on('scroll.bs.scrollspy', process)
    this.refresh()
    this.process()
  }
