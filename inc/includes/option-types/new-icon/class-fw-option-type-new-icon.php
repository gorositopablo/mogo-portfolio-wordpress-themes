...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    private function generate_unknown_set($icon) {
        return array(
            ...
            'container-class' => '',
            'groups' => array(
                'unknown' => __('Unknown Set', 'startuplanding'),
            ),
            'icons' => array(
    ...
    private function get_default_sets() {
		...
		//     groups => array(
        //         array(
        //             'title' => __('Web Application Icons', 'startuplanding')
        //             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
        //         ),
        //         array(
        //             'title' => __('Transportation Icons', 'startuplanding'),
        //             'icons' => array(...),
        //         ),
        //     )
        //
        ...
        return array(
            'font-awesome' => array(// http://fortawesome.github.io/Font-Awesome/icons
                ...
                'groups' => array(
                    'web-application' => __('Web Application Icons', 'startuplanding'),
                    'hand' => __('Hand Icons', 'startuplanding'),
                    'transportation' => __('Transportation Icons', 'startuplanding'),
                    'gender' => __('Gender Icons', 'startuplanding'),
                    'file-type' => __('File Type Icons', 'startuplanding'),
                    //'spinner'         => 'Spinner Icons',
                    //'form-control'    => 'Form Control Icons',
                    'payment' => __('Payment Icons', 'startuplanding'),
                    //'chart'           => 'Chart Icons',
                    'currency' => __('Currency Icons', 'startuplanding'),
                    'text-editor' => __('Text Editor Icons', 'startuplanding'),
                    'directional' => __('Directional Icons', 'startuplanding'),
                    'video-player' => __('Video Player Icons', 'startuplanding'),
                    'brand' => __('Brand Icons', 'startuplanding'),
                    'medical' => __('Medical Icons', 'startuplanding'),
                    'line-icon' => __('Custom Liner Icons', 'startuplanding'),
                ),
                'icons' => array(
