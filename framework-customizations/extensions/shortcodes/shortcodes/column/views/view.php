...
if ($atts['height'] != 'auto') {
    ...
    $extra_height = "style=\"height:".$height."px;\"";
} else {
...
<div id="<?php echo $id; ?>" class="<?php echo esc_attr($atts['tablet']); ?> <?php echo $id_to_class[$atts['width']]; ?> <?php echo $offset; ?>  <?php echo esc_attr($atts['class']); ?>  <?php echo esc_attr($atts['default_padding']); ?> wow <?php echo $atts['animation'] ?>" data-wow-offset="120" data-wow-duration="1.5s" style=" <?php echo $bg_image . ' ' . $bg_color;?> <?php echo $txtcolor;?>">
    <?php echo $overlay_color; ?>
    <div class="fw-main-row"  <?php echo $extra_height;?>>
        <div class="fw-col-inner"<?php echo $style; ?>>
            <?php echo mogo_theme_translate(esc_textarea(do_shortcode($content))); ?>
        </div>
    </div>
</div>